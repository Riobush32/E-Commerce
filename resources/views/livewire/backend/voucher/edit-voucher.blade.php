<div>
    ...
    @if ($showEditVoucher)
        <div class="fixed inset-0 flex items-center justify-center" >
            <div class="ralative card bg-base-100 w-[800px] shadow-xl" wire:click.outside="$set('showEditVoucher', false)">
                <button wire:click="$set('showEditVoucher', false)" class="absolute top-5 right-5 btn btn-circle btn-outline btn-xs">
                    <i class="fa-solid fa-xmark"></i>
                </button>
                <form wire:submit="editVoucher" class="card-body max-h-[70vh] overflow-auto">
                    ...
                    <div class="">
                        <div class="grid grid-cols-3 gap-8 mt-3 ">
                            <fieldset class="fieldset">
                                ...
                                <input wire:model.live="voucherName" type="text"
                                    class="input input-sm w-full" placeholder="Type here" />
                            </fieldset>
                            <fieldset class="fieldset">
                                <legend class="fieldset-legend mb-2 text-sm">Poins Reqiured</legend>
                                <input wire:model.live="voucherPoins" min=1
                                    type="number" class="input input-sm w-full" placeholder="Type here" />
                            </fieldset>
                            <fieldset class="fieldset">
                                <legend class="fieldset-legend mb-2 text-sm">Minimal Purchase</legend>
                                <input wire:model.live="voucher_min_purchase" 
                                    class="input input-sm w-full join-item " oninput="formatCurrency(this)"
                            ...
                            <fieldset class="fieldset">
                                ...
                                <input 
                                    wire:model.live="voucher_discount_value" type="text"
                                    class="input input-sm w-full" placeholder="Type here" value=""
                        ...
                        <div class="w-full flex justify-center mt-10 ">
                            <calendar-range id="myRangeCalendarEdit" months="2">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            document.getElementById("myRangeCalendarEdit").addEventListener("change", (event) => {
