<div @click.outside="formAddCategory=false">
    ...
    <div class="ralative card bg-base-100 max-w-[800px] shadow-xl">
        <button @click="formAddCategory = false" class="absolute top-5 right-5 btn btn-circle btn-outline btn-xs">
        ...
        <div class="card-body max-h-[70vh] overflow-auto">
            ...
            <form wire:submit.prevent="saveNewCategory" class="border-2 border-dashed border-green-600 rounded-xl p-4">
                ...
                <div class="mx-auto bg-white rounded-lg shadow-lg p-2">
                    ...
                    <div class="flex items-center ">
                        <input wire:model.live="iconId" value="{{ $icon->id }}" type="radio" id="radio{{ $index }}" name="radio" class="hidden peer" />
                        <label for="radio{{ $index }}" class="flex items-center cursor-pointer peer-checked:bg-fuchsia-600 peer-checked:text-white px-2 py-1 bg-gray-200 rounded-lg">
