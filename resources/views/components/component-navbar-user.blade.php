<div x-data="{ avatar: false }">
    ...
    <div class="w-full flex items-center justify-arund gap-2 px-16 py-2">
        ...
        <div class="w-2/6 flex items-center gap-5 justify-end">
            ...
            @guest
                <a href="{{ route('login') }}" class="btn btn-sm btn-primary text-white tracking-widest font-light">Login</a>
                <a href="{{ route('register') }}" class="btn btn-sm btn-outline btn-primary text-white  tracking-widest font-light">register</a>
            @else
                {{-- user  --}}
        ...
        <div class="mt-2 absolute z-10 right-24 max-h-[50vh] overflow-auto rounded-xl" x-show="avatar"
            ...
            <div
                ...
                <div class="flex flex-col items-center">
                    ...
                    <div class="mt-2">
                        <a href="{{ route('logout')}} "
                            class="btn btn-ghost text-rose-300 border border-rose-400 hover:text-red-500 font-light tracking-widest" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                            logout</a>
