<section class="md:flex gap-4 w-full max-h-[510px] justify-center items-center overflow-hidden rounded-xl">
    ...
    <div class="hidden w-1/3 gap-4 py-5 content-between md:grid grid-cols-1 h-full">
        ...
        @else
            <div
                class="shadow-inner bg-slate-100 flex max-h-[210px] items-center overflow-hidden rounded-xl  hover:bg-slate-200 ease-in-out duration-300">
            ...
            {{-- banner ke 3  --}}
            <div
                class="shadow-inner bg-slate-100 flex max-h-[210px] items-center overflow-hidden rounded-xl justify-items-stretch hover:bg-slate-200 ease-in-out duration-300">
                <div class="w-2/3 pl-5 mt-8 z-10">
                    <h1 class="text-xl mb-3">Lorem ipsum dolo.</h1>
                    <p class="text-primary text-xl font-bold tracking-wide">Rp 200.000,00</p>
                    <p class="text-neutral line-through">Rp 248.900,00</p>
