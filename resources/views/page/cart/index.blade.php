<x-layouts-main>
    <div class="my-5">
        ...
        <h2>3 items <span class="text-gray-500">in your bag.</span></h2>
    </div>
    {{-- cart  --}}
    <div class="flex gap-3">
        <div class="w-4/5">
            ...
            @for ($i = 0; $i < 5; $i++)
                <input type="checkbox" id="product-1" value="" class="hidden peer" required="">
                <label for="product-1"
                    class="p-2 rounded-xl  grid grid-cols-5 gap-4 w-full mt-5 peer-checked:border peer-checked:border-primary peer-checked:shadow-xl"
                    x-data="{ count: 0, price: 300000 }">
                    <div class="flex gap-3 " style="grid-column: span 2">
                        ...
                        <div class="grid grid-cols-1 content-around h-full">
                            <div class="">
                                <h1 class="text-secondary">Eiger</h1>
                                <h3 class="text-xl">baju distro Pria</h3>
                            </div>
                            <div class="">
                                <span class="text-secondary">Color:</span> red
                            </div>
                        </div>
                    </div>
                    {{-- price  --}}
        ...
        <div class="w-1/5 relative -z-10">
            <div class="fixed bottom-16 h-[70vh] p-3 w-1/5">
                ...
                <a class="cursor-pointer">
                    ...
                    <p class="text-secondary text-xs">Jl. Melati No. 123, Kelurahan Sejahtera, Kecamatan Harmoni, Kota Bahagia, Provinsi Gemilang, 54321</p>
                </a>
